    ...
    return declare([BaseWidgetPanel, _TemplatedMixin], {
      ...
      makePositionInfoBox: function () {
         var _w, _h, _l, _t, _r, _b;
          ...
          try {
              if (this.config.positionpanel)
              {
                  _w = (typeof(this.config.positionpanel.width) != 'undefined') ? this.config.positionpanel.width : 250;
                  _h = (typeof(this.config.positionpanel.height) != 'undefined') ? this.config.positionpanel.height : 350;

                  _l = (typeof(this.config.positionpanel.left) != 'undefined') ? this.config.positionpanel.left : "auto";
                  _r = (typeof(this.config.positionpanel.right) != 'undefined') ? this.config.positionpanel.right : "auto";

                  _t = (typeof(this.config.positionpanel.top) != 'undefined') ? this.config.positionpanel.top : "auto";
                  _b = (typeof(this.config.positionpanel.bottom) != 'undefined') ? this.config.positionpanel.bottom : "auto";

                  if (_t == "auto" && _b == "auto" )
                  {
                      _t = this.position.top || 0;
                  }
                  if (_l == "auto" && _r == "auto") {
                      _l = this.position.left || 0;
                  }

              }
              else
              {
                  _w = this.position.width || 250;
                  _h = this.position.height || 350;
                  _l = this.position.left || 0;
                  _t = this.position.top || 0;
                  _r = "auto";
                  _b = "auto";
      ...
      _makeOriginalBox: function() {
        this._originalBox = {
          w: this.position.width || 250,
          h: this.position.height || 350,
