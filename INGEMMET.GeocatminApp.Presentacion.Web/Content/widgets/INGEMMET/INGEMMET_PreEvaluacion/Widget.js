define(['dojo/_base/declare',
        ...
        "dijit/registry",
        "dojo/number",
        "jimu/dijit/DrawBox", 'dojo/on', 'dojo/_base/lang', 'esri/layers/GraphicsLayer',
        "esri/Color",
  ...
  function (declare,
            ...
            Query,
            SimpleLineSymbol,
            SimpleFillSymbol, geometryEngine, SimpleMarkerSymbol, MultiSelect) {
      //To create a widget, you need to derive from BaseWidget.
      return declare([BaseWidget, _WidgetsInTemplateMixin], {
          // Custom widget code goes here
          _graphicsLayer: null,
          baseClass: 'jimu-widget-PreEvaluacion',
          queryTask: null,
          geometryService: null,
          //this property is set by the framework when widget is loaded.
          name: 'PreEvaluacionWidget',
